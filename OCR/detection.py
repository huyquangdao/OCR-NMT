from OCR.pretrained.detection.craft import CRAFT
from OCR.pretrained.detection import imgproc
from OCR.pretrained.detection import craft_utils
import torch
...
from OCR.config.config import DETECTION_CONFIG
class TextDetection:
